...
<div>
 ...
 <button className="hover:bg-blue-500 mx-4">Find my Tickets</button>
  ...
  <input type="text" name="" id="" className="rounded-md bg-gray-300 mx-4" placeholder='Seacrh Event...'/>
  <button className="bg-blue-700 p-1 px-5 text-black rounded-full hover:bg-blue-600">
    ...
    <button className="bg-blue-800 p-2 px-5 text-white rounded-full hover:bg-blue-300 mx-4">Sign Up</button>
    </div> 
